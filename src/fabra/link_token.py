...
class LinkToken:
    ...
    def create_link_token(self, request: shared.CreateLinkTokenRequest) -> operations.CreateLinkTokenResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, shared.CreateLinkTokenRequest, "request", False, False, 'json')
        ...
        res = operations.CreateLinkTokenResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
