...
class Source:
    ...
    def create_source(self, request: shared.SourceInput) -> operations.CreateSourceResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, shared.SourceInput, "request", False, False, 'json')
    ...
    def get_sources(self) -> operations.GetSourcesResponse:
        ...
        res = operations.GetSourcesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
