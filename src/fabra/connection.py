...
class Connection:
    ...
    def get_tables(self, request: operations.GetTablesRequest) -> operations.GetTablesResponse:
        ...
        query_params = { **utils.get_query_params(operations.GetTablesRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.GetTablesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
