...
class Object:
    ...
    def create_object(self, request: shared.ObjectInput) -> operations.CreateObjectResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, shared.ObjectInput, "request", False, False, 'json')
        ...
        res = operations.CreateObjectResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_objects(self) -> operations.GetObjectsResponse:
        ...
        res = operations.GetObjectsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
