...
class Sync:
    ...
    def create_sync(self, request: shared.SyncInput) -> operations.CreateSyncResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, shared.SyncInput, "request", False, False, 'json')
    ...
    def get_syncs(self) -> operations.GetSyncsResponse:
        ...
        res = operations.GetSyncsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
